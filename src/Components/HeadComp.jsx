                    ...
                    <div className="col-xl-6">
                        <div className="text-center text-white">
                            ...
                            <form className="form-subscribe" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div className="row">
                                    <div className="col">
                                        <input className="form-control form-control-lg" id="emailAddress" type="email" placeholder="Email Address" data-sb-validations="required,email" value={Email} onChange={handleChange} onFocus={()=>setIsFocused(true)} onBlur={()=>{
                                            setIsFocused(true);
                                            if (!Email) {
                                    ...
                                    <div className="col-auto"><button className="btn btn-primary btn-lg disabled" id="submitButton" type="submit" disabled={!isFormValid}>Submit</button></div>
                                </div>
